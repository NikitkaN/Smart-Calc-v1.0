...
#include <memory>
#include "../SmartCalc_1/graphics.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_graphics_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_graphics_t qt_meta_stringdata_graphics = {
    {
QT_MOC_LITERAL(0, 8), // "graphics"
QT_MOC_LITERAL(9, 16), // "go_to_mainwindow"
QT_MOC_LITERAL(26, 0), // ""
QT_MOC_LITERAL(27, 15), // "pushButton_back"
QT_MOC_LITERAL(43, 9) // "push_draw"

    },
    "graphics\0go_to_mainwindow\0\0pushButton_back\0"
    "push_draw"
};
...
void graphics::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&graphics::go_to_mainwindow)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject graphics::staticMetaObject = { {
    ...
    qt_meta_stringdata_graphics.offsetsAndSize,
    qt_meta_data_graphics,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_graphics_t
, QtPrivate::TypeAndForceComplete<graphics, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>
...
// SIGNAL 0
void graphics::go_to_mainwindow()
{
