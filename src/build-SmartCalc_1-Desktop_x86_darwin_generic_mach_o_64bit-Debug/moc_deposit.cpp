...
QT_MOC_LITERAL(8, 16), // "go_to_mainwindow"
QT_MOC_LITERAL(25, 0), // ""
QT_MOC_LITERAL(26, 15), // "pushButton_back"
QT_MOC_LITERAL(42, 17) // "pushButton_result"

    },
    "deposit\0go_to_mainwindow\0\0pushButton_back\0"
    "pushButton_result"
};
...
void deposit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (deposit::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&deposit::go_to_mainwindow)) {
                *result = 0;
                return;
            }
        }
...
, QtPrivate::TypeAndForceComplete<deposit, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>
